...
#history = custom_model.fit_generator( train_set, epochs=1, validation_data=train_set, validation_steps=10)
...
#    print(parameters)
    ...
    os.system('rm -rf model_client1.h5')
    ...
    custom_model.save("./model_client1.h5")
